                                    ...
                                    <div className="mt-7 flex space-x-3 w-full">
                                        ...
                                        <div className="flex-grow mt-2">
                                            ...
                                            <div className="flex items-center justify-between pt-2.5">
                                                ...
                                                <button
                                                    className="bg-[#1d9bf0] text-white rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#1a8cd8] disabled:pointer-events-none disabled:opacity-50 disabled:cursor-default"
                                                    type="submit"
                                                    onClick={sendComment}
